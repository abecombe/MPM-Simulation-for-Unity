...
#define INTERPOLATE_X(SUM, C_INDEX, P_INDEX, S, WEIGHT, GRID_VELOCITY_BUFFER) {\
...
float3x4 sum_y = 0;\
INTERPOLATE_X(sum_y, C_INDEX + int3(0, -1, 0), P_INDEX, S, S0(S.y), GRID_VELOCITY_BUFFER)\
INTERPOLATE_X(sum_y, C_INDEX + int3(0, 0, 0), P_INDEX, S, S1(S.y), GRID_VELOCITY_BUFFER)\
INTERPOLATE_X(sum_y, C_INDEX + int3(0, 1, 0), P_INDEX, S, S2(S.y), GRID_VELOCITY_BUFFER)\
sum_y *= WEIGHT;\
SUM += sum_y;\
}\

#define INTERPOLATE_Z(SUM, C_INDEX, P_INDEX, S, GRID_VELOCITY_BUFFER) {\
INTERPOLATE_Y(SUM, C_INDEX + int3(0, 0, -1), P_INDEX, S, S0(S.z), GRID_VELOCITY_BUFFER)\
INTERPOLATE_Y(SUM, C_INDEX + int3(0, 0, 0), P_INDEX, S, S1(S.z), GRID_VELOCITY_BUFFER)\
INTERPOLATE_Y(SUM, C_INDEX + int3(0, 0, 1), P_INDEX, S, S2(S.z), GRID_VELOCITY_BUFFER)\
}\

#define INTERPOLATE(B_VELOCITY, C_INDEX, S, GRID_VELOCITY_BUFFER) \
INTERPOLATE_Z(B_VELOCITY, C_INDEX, C_INDEX, S, GRID_VELOCITY_BUFFER)\
...
INTERPOLATE(b_velocity, c_index, s, GRID_VELOCITY_BUFFER)\
float3x3 B;\
